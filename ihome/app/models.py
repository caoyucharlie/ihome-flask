...
class House(BaseModel, db.Model):
    ...
    user_id = db.Column(db.Integer, db.ForeignKey("ihome_user.id"), nullable=False)  # 房屋主人信息
    area_id = db.Column(db.Integer, db.ForeignKey("ihome_area.id"), nullable=False)  # 归属地的区域编号
